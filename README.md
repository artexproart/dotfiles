...
Этот репозиторий включает интеграцию с настройками GNOME для быстрого развертывания рабочей среды.

### Структура проекта

dotfiles/
├── config/
│ └── gnome/ # Настройки GNOME Shell
│ ├── dconf-backup/ # Полный дамп настроек dconf
│ ├── config/ # Конфигурации приложений
│ └── scripts/ # Скрипты синхронизации
├── dwm/ # Настройки DWM
├── apps/ # Конфигурации приложений
├── bash/ # Настройки bash
├── nvim/ # Конфигурации Neovim
└── alacritty/ # Настройки терминала


### Поддерживаемые настройки GNOME
- **Расширения**: Space Bar, Just Perfection, Workspace Indicator
- **Темы**: GTK-3.0/4.0, пользовательские стили
- **Горячие клавиши**: управление рабочими столами
- **Интерфейс**: панели, рабочие столы, анимации
- **Автоматическая синхронизация**: через dconf и конфигурационные файлы
